<div align="center">
  ...
  <p>Run Claude Code, OpenCode, and Codex sessions in parallel. One window. Isolated branches. No tab chaos.</p>
  <p>
...
Hive runs natively on **macOS**, **Windows**, and **Linux** — no setup gymnastics required.
