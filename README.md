<div align="center">
  ...
  <h1>Hive</h1>
  <p><strong>An open-source AI agent orchestrator for parallel coding across multiple projects.</strong></p>
  <p>Run Claude Code, OpenCode, and Codex sessions side by side. One window. Isolated branches. No tab juggling.</p>
  <p>
